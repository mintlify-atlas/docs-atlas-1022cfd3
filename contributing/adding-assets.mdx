---
title: "Add New Assets to the Dev Forge CDN Repository"
...
<Steps>
  ...
  <Step title="Update the README.md in the target folder">
    ...
    **Columns explained:**
    ...
    You can use `@main` as the ref while preparing your PR; once your commit is merged you should update the ref to a pinned commit SHA (see step 5) so the link remains stable even if the file is later moved.
  ...
  <Step title="Commit and push your changes">
    ...
    Open a Pull Request on GitHub targeting the `main` branch of `tutosrive/images-projects-srm-trg` if you are working from a fork.
  ...
  <Step title="Get the commit SHA and construct your pinned CDN URL">
    After your commit is merged into `main`, retrieve the full 40-character commit SHA from GitHub. You can find it in two ways:
    ...
    **Option A — GitHub web UI:**
    ...
    3. Locate your merge commit and click the **copy** icon next to the short SHA on the right
